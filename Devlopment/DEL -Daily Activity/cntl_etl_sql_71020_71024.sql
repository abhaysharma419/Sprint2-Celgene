...
VALUES
  (71020,'jp3a_cdw.rpt_insn_dr_prd_all_daily_atvy','DEL','insert into jp2_int.dr_insn_actv_all_ntrgt_daily
...
left join (select distinct bp_extl_idnty_val_txt, bp_sk from  jp2a_cdw.d_bp_extl_idnty where bp_extl_idnty_type_cd = ''ULT_ID'') bi_dr on dr_bp.bp_sk=bi_dr.bp_sk;',1,DATE '2019-09-05','cdwjpetl01',TIMESTAMP '2019-09-05 16:14:42.614','cdwjpetl01','p_cdw_jp_rpt_sorg_prd_dr_insn_all_atvy'),
  (71021,'jp3a_cdw.rpt_insn_dr_prd_all_daily_atvy','DEL','insert into  jp2_int.regn_dst_terr_mr_dr_insn_actv_daily
...
FROM (
	...
	);',1,DATE '2019-09-05','cdwjpetl01',TIMESTAMP '2019-09-05 16:14:42.614','cdwjpetl01','p_cdw_jp_rpt_sorg_prd_dr_insn_all_atvy'),
  (71023,'jp3a_cdw.rpt_insn_dr_prd_all_daily_atvy','DEL','insert into jp3a_cdw.RPT_INSN_DR_PRD_ALL_DAILY_ATVY
...
,''jp_ops'' as MODF_BY_NM	
  ...
  GROUP BY a.bp_sk, a.insn_nm, c.pset_sk, a.cald_dt_sk::integer, a.bp_par_sk, a.dr_nm,a.insn_cd,c.prd_shrt_ds,a.dr_cd) derived_table1;',1,DATE '2019-09-05','cdwjpetl01',TIMESTAMP '2019-09-05 16:14:42.614','cdwjpetl01','p_cdw_jp_rpt_sorg_prd_dr_insn_all_atvy'),
  (71024,'jp3a_cdw.rpt_insn_dr_prd_all_daily_atvy','DEL','insert into jp_rpt_A.RPT_INSN_DR_PRD_ALL_DAILY_ATVY
select *,(select coalesce(max(snp_id),0)+1 snp_id from  jp_ops.cntl_rpt_snp 
  where lower(tbl_nm)=''rpt_insn_dr_prd_all_daily_atvy'' and actv_flag=1) AS snp_id  from jp3a_cdw.RPT_INSN_DR_PRD_ALL_DAILY_ATVY;',1,DATE '2019-09-05','cdwjpetl01',TIMESTAMP '2019-09-05 16:14:42.614','cdwjpetl01','p_cdw_jp_rpt_sorg_prd_dr_insn_all_atvy');
