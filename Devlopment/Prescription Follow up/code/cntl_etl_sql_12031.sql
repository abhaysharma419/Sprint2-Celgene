UPDATE apac_orch.cntl_etl_sql
   SET sql_txt = 'INSERT INTO jp3a_cdw.s_insn_dr_prd_mth_pat_trk
With patient as (
...
/* Product - HEMA group  Start */

/* Product - HEMA new patient*/
union all 
...
UNION ALL 
/* Potential Patinet for ONC1(OP MELA ,OPYV MELA,YV,OP LC,OP HN,OP RCC,OPYV RCC)  Products*/
...
left outer join jp_ops.m_pset_prd_grp  pg on dp.pset_id=pg.pset_id 
left outer join jp2a_cdw.d_pset dp2  on pg.prd_grp_id=dp2.pset_id 
where  subj_area_nm=''patient''  and pat_type_ds in (''New Patients'') and dp2.prd_shrt_ds in (''IO MELA'', ''IO RCC'', ''IO CRC'',''HEMA MM'',''HEMA LYM''))
...
left outer join jp_ops.m_pset_prd_grp  pg on dp.pset_id=pg.pset_id 
left outer join jp2a_cdw.d_pset dp2  on pg.prd_grp_id=dp2.pset_id 
where  subj_area_nm=''patient''  and pat_type_ds in (''New Patients'') and dp2.prd_shrt_ds not in (''IO MELA'', ''IO RCC'', ''IO CRC'',''HEMA MM'',''HEMA LYM''))
group by bp_par_sk, bp_sk,pset_sk , mth_cald_dt_sk, pat_type_ds,
pat_type_lcl_lang_ds, trtt_ln_txt
...
left outer join jp_ops.m_pset_prd_grp  pg on dp.pset_id=pg.pset_id 
left outer join jp2a_cdw.d_pset dp2  on pg.prd_grp_id=dp2.pset_id 
where  subj_area_nm=''patient''  and pat_type_ds in (''Potential Patients'') and dp2.prd_shrt_ds  in (''IO LC'',''IO HN'',''IO EC'',''HEMA MDS'',''HEMA ATLL'',''HEMA CML'',''HEMA HL''))
group by bp_par_sk, bp_sk,pset_sk , mth_cald_dt_sk, pat_type_ds,
pat_type_lcl_lang_ds, trtt_ln_txt
...
left outer join jp_ops.m_pset_prd_grp  pg on dp.pset_id=pg.pset_id 
left outer join jp2a_cdw.d_pset dp2  on pg.prd_grp_id=dp2.pset_id 
where  subj_area_nm=''patient''  and pat_type_ds in (''Potential Patients'') and dp2.prd_shrt_ds  in (''IO MELA'',''IO RCC'',''IO CRC'',''HEMA MM'',''HEMA LYM''))
group by bp_par_sk, bp_sk,pset_sk , mth_cald_dt_sk, pat_type_ds,
pat_type_lcl_lang_ds, trtt_ln_txt
