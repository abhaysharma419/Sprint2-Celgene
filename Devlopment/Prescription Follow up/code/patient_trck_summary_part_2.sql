...
left outer join jp_ops.m_pset_prd_grp  pg on dp.pset_id=pg.pset_id 
left outer join jp2a_cdw.d_pset dp2  on pg.prd_grp_id=dp2.pset_id 
where  subj_area_nm='patient'  and pat_type_ds in ('Potential Patients') and dp2.prd_shrt_ds  in ('IO EC','HEMA MDS','HEMA ATLL','HEMA CML','HEMA HL'))
group by bp_par_sk, bp_sk,pset_sk , mth_cald_dt_sk, pat_type_ds,
pat_type_lcl_lang_ds, trtt_ln_txt
...
left outer join jp_ops.m_pset_prd_grp  pg on dp.pset_id=pg.pset_id 
left outer join jp2a_cdw.d_pset dp2  on pg.prd_grp_id=dp2.pset_id 
where  subj_area_nm='patient'  and pat_type_ds in ('Potential Patients') and dp2.prd_shrt_ds  in ('IO CRC','HEMA MM','HEMA LYM'))
group by bp_par_sk, bp_sk,pset_sk , mth_cald_dt_sk, pat_type_ds,
pat_type_lcl_lang_ds, trtt_ln_txt
